...
:::image type="content" source="../images/code-editor-intro.png" alt-text="Редактор кода, показывающий код сценария, используемый в этом руководстве":::
