...
> [!NOTE]
> Эта функция скоро станет доступна для пользователей с подпиской Microsoft 365; она доступна не всем. Он постепенно выпускается для большего количества пользователей, чтобы убедиться в ее правильной работе. Эта функция может быть изменена с учетом ваших отзывов. Неподдерживаемые платформы и версии Office без этой функции будут показывать очертания кнопки скрипта, но кнопку нельзя будет нажать.
