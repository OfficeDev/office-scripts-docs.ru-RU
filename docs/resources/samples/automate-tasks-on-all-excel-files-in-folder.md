...
Выполняет вычисления по Excel, добавляет форматирование и вставляет комментарий, [@mentions коллегу](https://support.microsoft.com/office/90701709-5dc1-41c7-aa48-b01d4a46e8c7).

## <a name="sample-excel-files"></a>Пример Excel файлов

<a href="https://github.com/OfficeDev/office-scripts-docs/blob/master/docs/resources/samples/highlight-alert-excel-files.zip?raw=true"> Скачайтеhighlight-alert-excel-files.zip</a> для всех книг, необходимых для этого примера. Извлечение этих файлов в папку с названием **Sales**. Добавьте следующий сценарий в свою коллекцию скриптов, чтобы попробовать пример самостоятельно!
...
1. В **филиале If Yes** **добавьте соединителю Excel Online (Бизнес)** с действием **сценария Run**. Используйте следующие значения для действия.
    ...
    1. **Файл**: **Id** (значение OneDrive файла)
...
[Посмотрите, как суди Рамамурти (Sudhi Ramamurthy) пройдите этот пример на YouTube](https://youtu.be/xMg711o7k6w).
