...
| [Узнайте основы использования объекта Range в Office Скрипты](range-basics.md) | В этой статье показаны основы использования объекта Range и его API. Это фундаментальная тема, которая будет использоваться во всех других проектах. |

## <a name="beyond-the-basics"></a>Более сложные действия

Ознакомьтесь со следующим конечным проектом, который автоматизирует примеры сценариев вместе с полными сценариями, примерами используемых Excel и [видео.](https://www.youtube.com/playlist?list=PLr3zVPZrMOUMl88fs8uc2GGAePRnNe6m0)
...
| [Перекрестная ссылка и формат Excel файла](excel-cross-reference.md) | Это решение показывает, как Excel двух файлов можно перекрестно ссылаться и форматирование с помощью Office и Power Automate. |
...
| [Объединение нескольких Excel таблиц в одну таблицу](copy-tables-combine.md) | Этот пример объединяет данные из нескольких Excel таблиц в одну таблицу, которая включает все строки. |
...
| [Отправка собрания Teams из Excel данных](send-teams-invite-from-excel-data.md) | В этом решении показано, как использовать Office скрипты и Power Automate для выбора строк из Excel файла и использования его для отправки приглашения Teams собрания, а затем обновления Excel. |
...
## <a name="community-contributions"></a>Вклад сообщества
