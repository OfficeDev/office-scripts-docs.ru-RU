...
ms.locfileid: "62220409"
---
# <a name="office-scripts-samples-and-scenarios"></a>Office сценариев и сценариев
...
| [Создание таблицы содержимого книги](table-of-contents.md) | В этом примере создается таблица контента со ссылками на каждый таблицу. |
