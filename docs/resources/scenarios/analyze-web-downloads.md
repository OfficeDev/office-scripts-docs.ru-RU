---
title: 'Office сценария сценариев: Анализ веб-загрузки'
...
ms.locfileid: "61333500"
---
# <a name="office-scripts-sample-scenario-analyze-web-downloads"></a>Office сценария сценариев: Анализ веб-загрузки
