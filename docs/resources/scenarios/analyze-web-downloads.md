---
title: 'Office сценария сценариев: Анализ веб-скачиваемых'
...
---
# <a name="office-scripts-sample-scenario-analyze-web-downloads"></a>Office сценария сценариев: Анализ веб-скачиваемых

В этом сценарии вам будет поручено проанализировать отчеты о загрузке с веб-сайта вашей компании. Цель этого анализа состоит в том, чтобы определить, идет ли веб-трафик из США или в других частях мира.
...
1. <a href="analyze-web-downloads.xlsx"> Скачайтеanalyze-web-downloads.xlsx</a> в OneDrive.
